...
/// Rate in wich temperature is going to decrease
...
/// Size of each batch
const int L = 2000;
/// The heuristic is going to calculate the cost of a solution every PERIOD times in linear time (as opposed to constant as is normally done) to avoid accumulating decimal error
