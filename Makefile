...
main: DatabaseHandler.o Graph.o Metrologist.o GraphFiller.o Solution.o $(SRC_DIR)/main.cpp
	g++ $(SRC_DIR)/main.cpp DatabaseHandler.o Graph.o Metrologist.o Solution.o GraphFiller.o -l sqlite3 -o main
